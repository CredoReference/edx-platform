...
urlpatterns = [
    ...
    url(r'^get_courses_with_duplicates/{}?$'.format(settings.USAGE_KEY_PATTERN),
        contentstore.views.get_courses_with_duplicates,
    ...
    url(r'^update_block_in_related_courses_result/?$', contentstore.views.copy_section_to_other_courses_result,
    ...
    url(r'^export/{}$'.format(COURSELIKE_KEY_PATTERN), contentstore.views.export_handler,
        name='export_handler'),
    url(r'^export_cc/{}$'.format(COURSELIKE_KEY_PATTERN), contentstore.views.export_handler_cc,
    ...
    url(r'^turnitin/', include('turnitin_integration.urls')),
]
